...
(function ($) {
    ...
    var CurrencyInput = function (options) {
        this.init('currency', options, CurrencyInput.defaults);
    };
    $.fn.editableutils.inherit(CurrencyInput, $.fn.editabletypes.text);
    $.extend(CurrencyInput.prototype, {
        render: function () {
            this.$input = this.$tpl.find('input');
            CurrencyInput.superclass.render.call(this);
            if(typeof(this.$input.maskMoney) == "function") {
                this.$input.maskMoney();
            }
        }
    });
    CurrencyInput.defaults = $.extend({}, $.fn.editabletypes.text.defaults, {
        tpl: '<div class="input-prepend"><span class="add-on">$</span><input type="text"></div>',
        inputclass: 'input-small'
    });
    $.fn.editabletypes.currency = CurrencyInput;
}(window.jQuery));
